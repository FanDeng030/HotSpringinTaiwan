...
var lyr_2000_2 = new ol.layer.Image({
                            opacity: 1,
                            title: "2000年臺灣地質圖",
                            
                            
                            source: new ol.source.ImageStatic({
                               url: "./layers/2000_2.png",
    attributions: ' ',
...
var lyr_Basic_3 = new ol.layer.Vector({
                ...
                style: style_Basic_3,
                interactive: true,
                title: '<img src="styles/legend/Basic_3.png" /> 鹼性水質(Basic)'
            });
...
var lyr_Acidic_4 = new ol.layer.Vector({
                ...
                interactive: true,
                title: '<img src="styles/legend/Acidic_4.png" /> 酸性水質(Acidic)'
            });
...
var lyr_Neutral_5 = new ol.layer.Vector({
                ...
                interactive: true,
                title: '<img src="styles/legend/Neutral_5.png" /> 中性水質(Neutral)'
            });
...
var lyr_none_6 = new ol.layer.Vector({
                ...
                style: style_none_6,
                interactive: true,
                title: '<img src="styles/legend/none_6.png" /> 無水質資料(none)'
            });
...
var lyr_East_7 = new ol.layer.Vector({
                ...
                style: style_East_7,
                interactive: true,
                title: '<img src="styles/legend/East_7.png" /> 東部(East)'
            });
...
var lyr_South_8 = new ol.layer.Vector({
                ...
                style: style_South_8,
                interactive: true,
                title: '<img src="styles/legend/South_8.png" /> 南部(South)'
            });
...
var lyr_Central_9 = new ol.layer.Vector({
                ...
                interactive: true,
                title: '<img src="styles/legend/Central_9.png" /> 中部(Central)'
            });
...
var lyr_North_10 = new ol.layer.Vector({
                ...
                interactive: true,
                title: '<img src="styles/legend/North_10.png" /> 北部(North)'
            });
...
var lyr_Recommendation_11 = new ol.layer.Vector({
                ...
                interactive: true,
                title: '<img src="styles/legend/Recommendation_11.png" /> 推薦(Recommendation)'
            });
...
var lyr_HotSpring_12 = new ol.layer.Vector({
                ...
                interactive: true,
                title: '<img src="styles/legend/HotSpring_12.png" /> 溫泉(Hot Spring)'
            });

lyr_OSMStandard_0.setVisible(true);lyr_GoogleSatellite_1.setVisible(true);lyr_2000_2.setVisible(true);lyr_Basic_3.setVisible(true);lyr_Acidic_4.setVisible(true);lyr_Neutral_5.setVisible(true);lyr_none_6.setVisible(true);lyr_East_7.setVisible(true);lyr_South_8.setVisible(true);lyr_Central_9.setVisible(true);lyr_North_10.setVisible(true);lyr_Recommendation_11.setVisible(true);lyr_HotSpring_12.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_GoogleSatellite_1,lyr_2000_2,lyr_Basic_3,lyr_Acidic_4,lyr_Neutral_5,lyr_none_6,lyr_East_7,lyr_South_8,lyr_Central_9,lyr_North_10,lyr_Recommendation_11,lyr_HotSpring_12];
